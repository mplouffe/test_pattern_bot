...
const { generateHtmlImage } = require('./test-pattern-generator/html_image_generation')
...
const client = new Twitter({
    consumer_key: process.env.TEST_PATTERN_BOT_TWITTER_CONSUMER_KEY,
    consumer_secret: process.env.TEST_PATTERN_BOT_TWITTER_CONSUMER_SECRET,
    access_token_key: process.env.TEST_PATTERN_BOT_TWITTER_ACCESS_TOKEN_KEY,
    access_token_secret: process.env.TEST_PATTERN_BOT_TWITTER_ACCESS_TOKEN_SECRET
});
